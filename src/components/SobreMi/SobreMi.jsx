...
const SobreMi = () => {
  return (
    <div className="flex flex-col items-center ">
      <div className="flex flex-col sm:flex-row "> {/* Cambio aquí */}
        <div className="mx-auto w-5/6 h-96  sm:w-3/6 sm:h-5/6 sm:order-1 order-2 relative ml-14 mt-5 py-10 px-12 bg-violet-200 text-purple-700 text-left  "> {/* Cambio aquí */}
          {/* Aquí puedes agregar tu contenido de texto */}
          <h2 className="text-3xl mb-4 mt-1 px-1 m-9">Sobre Mi</h2>
          <p className="text-lg text-gray-700 px-1 m-9 mb-10">
            ...
            Mi formación es constante, mientras más incursionó en esta práctica milenaria, 
            más motivada me siento. 
            Mi propósito personal es acompañar los procesos dolorosos e incómodos que requiere nuestra existencia como seres humanos...
        ...
        <div
         className="mx-auto w-5/6 h-96 sm:w-2/5 sm:h-4/5 sm:order-2 order-1 mt-7 relative bg-cover bg-center hover:scale-105 transition-all duration-500 ease-in-out transform translate-x-[-22%]" 
         style={{ 
